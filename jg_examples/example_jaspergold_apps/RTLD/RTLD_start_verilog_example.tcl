...
#
database -set_focus 0
activate -behavior <embedded>::Transfer_Start {(arb.trans_started == 1'b0) ##1 (arb.trans_started == 1'b1)} \
-label {Transfer Start} -description {A transfer is starting.} -batch
